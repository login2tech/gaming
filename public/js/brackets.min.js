...
(function($){
    var get_html_player = function(player){
      ...
      var looser = player.looser ? 'looser' : '';
            var ID = player.ID ? player.ID : '';

            var html_player = '       <div class="player '+looser+' ' + winner + ' player-' + ID + '" data-id="' + ID + '">';
        ...
        get_html_match = function(match){
            var html_match = '   <div class="match"><span class="dib">'+match.match_title+'</span>';
        ...
        get_html = function(opts){
            ...
            $.each(rounds, function(r, round){
                html += '<div class="round rd-' + (r + 1) + '  '+(round[0].class?round[0].class:'')+' ">';
        ...
        get_width_container = function(max_brackets){
                let a = (max_brackets)*250 + (max_brackets-1)*5 ;
                return a+450;
        },

        get_height_container = function(max_brackets){
          // console.log(max_brackets)
          // console.log(key(max_brackets + 1))
        ...
        set_style = function(styles, n_brackets){
            ...
            css += "    color:.container-brackets .round " + styles.color_title + " !important;";
            css += "}";
            css += ".brackets-header .title{ float: left; width: 250px;  margin-right: 50px; text-align: center;}";
            ...
            css += "}";
            css += ".container-brackets .round{ width: 250px; margin-left: -40px; float: left;}";
            ...
            css += "        .container-brackets .round.rd-1 .match .player{ margin-top: 10px;margin-bottom:10px }";
            css += "/*-- First lines --*/";
            css += ".container-brackets .separator-brackets.rd-1 .line{";
            css += "    height: 60px;";
            css += "    margin-bottom:140px;";
            css += "}";
            css += "    .container-brackets .separator-brackets.rd-1 .line:first-child{ margin-top: 60px; }";
