...
export default function getRoutes(store) {
  ...
  return (
    ...
    <Route path="/" component={App}>
      ...
      <Route path="/admin_users" component={AdminUsers} onEnter={ensureAuthenticated} onLeave={clearMessages}/>
      <Route path="/app_users" component={AppUsers} onEnter={ensureAuthenticated} onLeave={clearMessages}/>
      <Route path="/teams/:uid" component={Teams} onEnter={ensureAuthenticated} onLeave={clearMessages}/>
      <Route path="/teams" component={Teams} onEnter={ensureAuthenticated} onLeave={clearMessages}/>


      <Route path="/matchfinder/:team_id" component={Matchfinder} onLeave={clearMessages} />
      <Route path="/matchfinder" component={Matchfinder} onLeave={clearMessages} />
